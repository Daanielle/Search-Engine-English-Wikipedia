    ...
    def read(self, locs, n_bytes):
        ...
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = open("C:/Users/aspir/OneDrive/Documents/NewSd/"+f_name, 'rb')
...
class InvertedIndex:  
    ...
    def write_a_posting_list(b_w_pl, bucket_name):
        ...
        with closing(MultiFileWriter("../../OneDrive/Documents/סמסטר א 2022/אחזור מידע פרוייקט", bucket_id, bucket_name)) as writer:
